...
//+kubebuilder:printcolumn:name="Observed mode",type=string,JSONPath=`.status.policyMode`,description="Policy deployment mode observed on the assigned Policy Server"
...
func (r *ClusterAdmissionPolicy) SetPolicyMode(policyMode PolicyMode) {
